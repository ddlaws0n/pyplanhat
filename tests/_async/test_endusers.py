...
from pyplanhat._async.resources.endusers import EndUser
...
@pytest.mark.asyncio
async def test_list_endusers_success(async_client, httpx_mock):
    ...
    endusers = await async_client.endusers.list()
...
@pytest.mark.asyncio
async def test_list_endusers_by_company(async_client, httpx_mock):
    ...
    endusers = await async_client.endusers.list(company_id="comp-123")
...
@pytest.mark.asyncio
async def test_list_endusers_empty(async_client, httpx_mock):
...
@pytest.mark.asyncio
async def test_get_enduser_success(async_client, httpx_mock):
    ...
    enduser = await async_client.endusers.get("user-123")
...
@pytest.mark.asyncio
async def test_get_enduser_not_found(async_client, httpx_mock):
    ...
    with pytest.raises(InvalidRequestError) as exc_info:
        await async_client.endusers.get("nonexistent")
...
@pytest.mark.asyncio
async def test_create_enduser_success(async_client, httpx_mock):
    ...
    created_enduser = await async_client.endusers.create(new_enduser)
...
@pytest.mark.asyncio
async def test_create_enduser_validation_error(async_client, httpx_mock):
    ...
    with pytest.raises(APIError) as exc_info:
        await async_client.endusers.create(enduser)
...
@pytest.mark.asyncio
async def test_update_enduser_success(async_client, httpx_mock):
    ...
    result = await async_client.endusers.update("user-123", updated_enduser)
...
@pytest.mark.asyncio
async def test_update_enduser_not_found(async_client, httpx_mock):
    ...
    with pytest.raises(InvalidRequestError) as exc_info:
        await async_client.endusers.update("nonexistent", enduser)
...
@pytest.mark.asyncio
async def test_delete_enduser_success(async_client, httpx_mock):
    ...
    await async_client.endusers.delete("user-123")


@pytest.mark.asyncio
async def test_delete_enduser_not_found(async_client, httpx_mock):
    ...
    with pytest.raises(InvalidRequestError) as exc_info:
        await async_client.endusers.delete("nonexistent")
...
@pytest.mark.asyncio
async def test_enduser_authentication_error(async_client, httpx_mock):
    ...
    with pytest.raises(AuthenticationError) as exc_info:
        await async_client.endusers.list()
...
@pytest.mark.asyncio
async def test_enduser_rate_limit_error(async_client, httpx_mock):
...
@pytest.mark.asyncio
async def test_enduser_server_error(async_client, httpx_mock):
