...
class Conversation(BaseModel):
    ...
    endusers: list[Any] | None = None  # Involved contact objects (auto-generated)
    ...
    @field_validator("user_ids", "tags", "activity_tags", "email_template_ids", mode="before")
    @classmethod
    ...
    @field_validator("users", "endusers", "time_bucket", "sender", "history", mode="before")
    @classmethod
...
class Conversations(BaseResource):
    ...
    async def list(self, company_id: str | None = None) -> list[Conversation]:
    ...
    async def update(self, conversation_id: str, conversation: Conversation) -> Conversation:
